...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="550" viewBox="0 0 1200 550" role="img" aria-labelledby="title description">
  ...
  <rect width="1200" height="550" rx="12" fill="{colors["background"]}"/>
  ...
  <line x1="490" y1="62" x2="490" y2="540" stroke="{colors["border"]}"/>
  <g transform="translate(4 8) scale(1.08)">{portrait}</g>
  {section(86, "SYSTEM")}
  {''.join(info_rows)}
  {section(266, "STACK")}
  {''.join(stack_rows)}
